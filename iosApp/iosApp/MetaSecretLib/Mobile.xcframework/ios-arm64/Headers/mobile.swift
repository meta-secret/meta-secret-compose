...
public func getAppInfo() -> String  {
    ...
    uniffi_mobile_fn_func_get_app_info($0
    )
})
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_mobile_checksum_func_get_app_info() != 46453) {
...
public func uniffiEnsureMobileInitialized() {
